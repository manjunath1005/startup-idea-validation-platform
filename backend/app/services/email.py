...
def send_otp_email(to_email: str, otp: str) -> bool:
    ...
    """
    # Print the OTP to the console logs so developers can see it without SMTP configured
    print("\n" + "=" * 50)
    ...
    # If SMTP is not configured, we successfully printed it to console so return True
    if not settings.SMTP_HOST:
        print("SMTP_HOST not configured. Skipping real email transmission.")
        return True
